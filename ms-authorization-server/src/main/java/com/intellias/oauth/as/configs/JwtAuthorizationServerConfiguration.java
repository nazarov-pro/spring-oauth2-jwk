...
public class JwtAuthorizationServerConfiguration {
    private static final String KEY_STORE_FILE = "intellias-jwt.jks";
    private static final String KEY_STORE_PASSWORD = "intellias-pass";
    private static final String KEY_ALIAS = "intellias-oauth-jwt";
    private static final String JWK_KID = "intellias-key-id";
